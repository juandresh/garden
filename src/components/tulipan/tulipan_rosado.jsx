  ...
  >
    ...
    >
      ...
      <g className={`cora ${corazon ? "corazon" : ""}`}>
        <path
          d="M18.834 34.67s-1.51-1.436-1.932-2.387c-.26-.587-.534-1.316-.311-1.92.117-.317.45-.55.763-.617.44-.096.975.028 1.309.35.316.305.436 1.285.436 1.285s.123-1.003.436-1.335c.218-.231.566-.342.872-.317.338.027.766.169.904.5.277.667-.19 1.478-.514 2.12-.463.919-1.963 2.32-1.963 2.32z"
          style={{
            display: "inline",
            fill: "#9e3b3b",
            fillOpacity: 1,
