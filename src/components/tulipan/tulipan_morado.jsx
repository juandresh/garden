...
const TulipanMorado = (props) => {
  ...
  <svg
    ...
    {...props}
    className={`tupAma ${props.className || ""}`}
  >
    <path
    ...
    >
      <path
        d="M21.599 26.305s-.247.308-.366.426c-.23.229-.528.595-.728.96-.333.605-.374.866-.43 1.149-.134.673-.104.898-.215 1.637-.042.285-.248 1.001-.24 1.29.009.256-.084 1.025-.082 1.281.008.965-.14 1.56-.265 2.142l.935-1.811.231-1.1.223-.802.066-1.488.133-1.058.223-.802.29-.869zM15.432 26.306s.388.198.569.308c.39.237.74.537 1.066.856.223.218.418.466.603.718.282.385.576.77.768 1.208.181.411.277.859.351 1.302.06.357.067.722.074 1.084.007.385-.032.77-.037 1.156-.009.642.029 1.284.007 1.925-.004.14-.029.417-.029.417s-.295-1.957-.553-2.919c-.14-.52-.402-1-.557-1.515-.146-.49-.19-1.103-.35-1.493-.163-.39-.354-.565-.528-.85-.263-.427-.693-1.255-.742-1.31-.605-.692-.642-.887-.642-.887z"
        style={{
          opacity: 1,
          fill: "#8174a0",
          fillOpacity: 1,
      ...
      <g className={`cora ${corazon ? "corazon" : ""}`}>
        <path
          d="M18.784 34.709s-1.51-1.436-1.932-2.387c-.26-.587-.534-1.315-.311-1.92.117-.317.45-.549.763-.617.44-.096.974.028 1.308.35.316.306.437 1.286.437 1.286s.123-1.003.436-1.335c.218-.232.566-.342.872-.317.338.027.766.169.904.5.277.667-.19 1.478-.514 2.12-.463.918-1.963 2.32-1.963 2.32z"
          style={{
            display: "inline",
            fill: "#9e3b3b",
            fillOpacity: 1,
